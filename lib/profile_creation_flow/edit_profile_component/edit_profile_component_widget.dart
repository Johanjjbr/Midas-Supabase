                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: ClipRRect(
                          borderRadius: BorderRadius.circular(8.0),
                          child: Image.memory(
                            _model.uploadedLocalFile_uploadData8ss254.bytes ??
                                Uint8List.fromList([]),
                            width: 300.0,
                            height: 200.0,
                            fit: BoxFit.cover,
              ...
              child: FFButtonWidget(
                onPressed: () async {
                  ...
                  if (selectedMedia != null &&
                    ...
                    safeSetState(
                        () => _model.isDataUploading_uploadData8ss254 = true);
                    ...
                    try {
                      ...
                      _model.isDataUploading_uploadData8ss254 = false;
                    }
                    if (selectedUploadedFiles.length == selectedMedia.length) {
                      safeSetState(() {
                        _model.uploadedLocalFile_uploadData8ss254 =
          ...
          Padding(
            ...
            child: FlutterFlowDropDown<String>(
              controller: _model.dropDownValueController ??=
                ...
                _model.dropDownValue ??= 'Vendedor',
              ),
              options: ['Vendedor', 'Director'],
              onChanged: (val) =>
