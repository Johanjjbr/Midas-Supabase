...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF9876D8);
  late Color secondary = const Color(0xFF9070D8);
  late Color tertiary = const Color(0xFF828282);
  late Color alternate = const Color(0x8A57636C);
  late Color primaryText = const Color(0xFF14181B);
  late Color secondaryText = const Color(0xFF57636C);
  late Color primaryBackground = const Color(0xFFF1F4F8);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0x4CDBDAE7);
  ...
  late Color colorCustom = const Color(0xFF007AFF);
}
