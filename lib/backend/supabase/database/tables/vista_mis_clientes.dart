...
class VistaMisClientesTable extends SupabaseTable<VistaMisClientesRow> {
  @override
  String get tableName => 'vista_mis_clientes';

  @override
  VistaMisClientesRow createRow(Map<String, dynamic> data) =>
      VistaMisClientesRow(data);
}

class VistaMisClientesRow extends SupabaseDataRow {
  VistaMisClientesRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => VistaMisClientesTable();
